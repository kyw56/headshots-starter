// app/interview/major/[majorId]/page.tsx
"use client";
...
export default function MajorInterviewSession() {
 ...
 return (
   <div className={`min-h-screen ${major.lightColor}`}>
     <div className={`bg-gradient-to-r from-blue-500 to-blue-700 text-white py-4 px-6 fixed top-0 w-full z-10 shadow-md`}>
       ...
       <div className="bg-white rounded-lg shadow-lg p-4 min-h-[70vh] flex flex-col">
         ...
         <div className="flex gap-2">
           ...
           <Button
             ...
             className="bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 transition-all shadow-sm px-4"
